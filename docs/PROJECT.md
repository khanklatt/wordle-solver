...
- Requirement 3.2: DEPRECATED - Previously implemented in `split_candidates_by_letter_uniqueness()` method, but no longer used. Candidates are now displayed as a sorted list with scoring used to prioritize solutions.
